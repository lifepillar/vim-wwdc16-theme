...
call s:HL("EndOfBuffer",  s:fg,          s:bg)
...
call s:HL("LineNr",       s:grey2,       s:black)
...
" call s:HL("Conditional",  s:fg,          s:bg)
call s:HL("Constant",     s:orange,      s:none)
call s:HL("Debug",        s:fusia,       s:bg)
" call s:HL("Define",       s:green,       s:bg)
call s:HL("Delimiter",    s:fg,          s:bg)
" call s:HL("Exception",    s:fg,          s:bg)
call s:HL("Float",        s:green,       s:none)
call s:HL("Function",     s:mintgreen,   s:none)
call s:HL("Identifier",   s:bluegreen,   s:none)
call s:HL("Ignore",       s:fg,          s:bg)
call s:HL("Include",      s:red,         s:bg)
call s:HL("Keyword",      s:forestgreen, s:bg)
call s:HL("Label",        s:green,       s:bg)
" call s:HL("Macro",        s:fg,          s:bg)
call s:HL("Number",       s:green,       s:bg)
call s:HL("Operator",     s:bluegreen,   s:bg)
" call s:HL("PreCondit",    s:fg,          s:bg)
call s:HL("PreProc",      s:red,         s:none)
" call s:HL("Repeat",       s:fg,          s:bg)
call s:HL("Special",      s:red,         s:none)
call s:HL("SpecialChar",  s:fusia,       s:bg)
call s:HL("SpecialComment", s:fusia,       s:bg)
call s:HL("Statement",    s:forestgreen, s:black)
call s:HL("StorageClass", s:bluegreen,   s:bg)
call s:HL("String",       s:mintgreen,   s:none)
call s:HL("Structure",    s:red,         s:bg)
" call s:HL("Tag",          s:fg,          s:bg)
call s:HL("Todo",         s:fusia,       s:none,   {'cterm': 'bold',      'gui': 'bold'})
call s:HL("Type",         s:purple,      s:none)
" call s:HL("Typedef",      s:orange,      s:bg)
