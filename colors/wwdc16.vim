...
call s:HL("ColorColumn",   s:white,       s:darkyellow)
call s:HL("Conceal",       s:blue,        s:none)
call s:HL("Cursor",        s:none,        s:black)
call s:HL("CursorIM",      s:none,        s:black)
...
call s:HL("DiffText",      s:white,       s:darkyellow)
call s:HL("Directory",     s:green,       s:none)
call s:HL("Error",         s:white,       s:darkred)
call s:HL("ErrorMsg",      s:white,       s:darkred)
...
call s:HL("MatchParen",    s:white,       s:magenta, {'cterm': 'bold', 'gui': 'bold'})
call s:HL("ModeMsg",       s:white,       s:darkblack)
call s:HL("MoreMsg",       s:black,       s:none)
...
call s:HL("PmenuThumb",    s:black,       s:darkyellow)
...
call s:HL("SpellBad",      s:none,        s:none, {'cterm': 'underline', 'gui': 'undercurl', 'guisp': 'magenta'})
call s:HL("SpellCap",      s:magenta,     s:none, {'cterm': 'underline', 'gui': 'undercurl', 'guisp': 'magenta'})
call s:HL("SpellLocal",    s:magenta,     s:none, {'cterm': 'underline', 'gui': 'undercurl', 'guisp': 'magenta'})
call s:HL("SpellRare",     s:magenta,     s:none, {'cterm': 'underline', 'gui': 'undercurl', 'guisp': 'magenta'})
call s:HL("StatusLine",    s:white,       s:blue)
call s:HL("StatusLineNC",  s:darkwhite,   s:blue)
...
call s:HL("Identifier",    s:darkcyan,    s:none)
call s:HL("Ignore",        s:fg,          s:bg)
call s:HL("PreProc",       s:blue,        s:none)
