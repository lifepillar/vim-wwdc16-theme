...
let s:brightred     = [s:rgb2hex(220, 60,  60),  9]
let s:brightgreen   = [s:rgb2hex(149, 199, 111), 10]
let s:brightyellow  = [s:rgb2hex(210, 142, 93),  11]
let s:brightblue    = [s:rgb2hex(70,  112, 216), 12]
...
call s:hl("SignColumn",               s:brightblack,   s:none)
call s:hl("SpecialKey",               s:brightblack,   s:none)
